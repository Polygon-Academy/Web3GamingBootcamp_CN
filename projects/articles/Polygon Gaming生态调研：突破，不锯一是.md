...
&emsp;&emsp;活跃用户数是衡量链游热度较为重要的参数之一，因此我们选取了DappRadar中近七天活跃用户数量大于1,000的排名前10的部署在Polygon上的链游作为本报告的重点分析对象。基于此，探究Polygon链游的当前热点以及发展趋势，为Polygon链游生态的发展提供相应的建议。
