...
export declare class HardhatNetworkProvider extends EventEmitter implements EIP1193Provider {
    ...
    constructor(_hardfork: string, _networkName: string, _chainId: number, _networkId: number, _blockGasLimit: number, _minGasPrice: BN, _throwOnTransactionFailures: boolean, _throwOnCallFailures: boolean, _automine: boolean, _intervalMining: IntervalMiningConfig, _logger: ModulesLogger, _genesisAccounts?: GenesisAccount[], _artifacts?: Artifacts | undefined, _allowUnlimitedContractSize?: boolean, _initialDate?: Date | undefined, _experimentalHardhatNetworkMessageTraceHooks?: BoundExperimentalHardhatNetworkMessageTraceHook[], _forkConfig?: ForkConfig | undefined, _forkCachePath?: string | undefined);
