...
exports.shouldShowTransactionTypeForHardfork = exports.toRpcLogOutput = exports.remoteReceiptToRpcReceiptOutput = exports.getRpcReceiptOutputsFromLocalBlockExecution = exports.getRpcTransaction = exports.getRpcBlock = void 0;
...
function getRpcTransaction(tx, showTransactionType, block, index) {
    ...
    return {
        ...
        gasPrice: base_types_1.numberToRpcQuantity(new ethereumjs_util_1.BN(tx.gasPrice)),
        ...
        type: showTransactionType || tx instanceof tx_1.AccessListEIP2930Transaction
            ? base_types_1.numberToRpcQuantity(tx.transactionType)
            : undefined,
        accessList: tx instanceof tx_1.AccessListEIP2930Transaction
            ...
            : undefined,
        chainId: tx instanceof tx_1.AccessListEIP2930Transaction
            ? base_types_1.numberToRpcQuantity(tx.chainId)
            : undefined,
    };
}
...
function remoteReceiptToRpcReceiptOutput(receipt, tx, showTransactionType) {
    return {
