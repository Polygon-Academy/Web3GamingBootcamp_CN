...
class BlockBuilder {
    ...
    async rewardMiner() {
        ...
        const coinbase = this.headerData.coinbase
            ? new ethereumjs_util_1.Address(ethereumjs_util_1.toBuffer(this.headerData.coinbase))
    ...
    async addTransaction(tx) {
        ...
        const blockGasLimit = new ethereumjs_util_1.BN(ethereumjs_util_1.toBuffer(this.headerData.gasLimit));
