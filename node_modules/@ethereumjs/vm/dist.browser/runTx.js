    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    if (!(opts.tx.transactionType !== 0 && this._common.isActivatedEIP(2718))) return [3 /*break*/, 8];
                ...
                case 5:
                    if (!(opts.tx.transactionType === 2 && !this._common.isActivatedEIP(1559))) return [3 /*break*/, 7];
                    return [4 /*yield*/, state.revert()];
                case 6:
                    _b.sent();
                ...
                case 7:
                    ...
                    castedTx.AccessListJSON.forEach(function (accessListItem) {
                        var address = ethereumjs_util_1.toBuffer(accessListItem.address);
...
function _runTx(opts) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var state, tx, block, caller, basefee, gasLimit, maxFeePerGas, baseFeePerGas, fromAccount, nonce, balance, cost, cost_1, gasPrice, inclusionFeePerGas, baseFee, baseFee, txCost, txContext, value, data, to, message, evm, results, gasRefund, maxRefundQuotient, maxRefund, actualTxCost, txCostDiff, miner, minerAccount, keys, keys_1, keys_1_1, k, address, e_2_1, cumulativeGasUsed, _b, event;
        var e_2, _c;
            ...
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (!opts.skipBalance) {
                        ...
                        if (tx instanceof tx_1.FeeMarketEIP1559Transaction) {
                            cost_1 = tx.gasLimit.mul(tx.maxFeePerGas);
                            if (balance.lt(cost_1)) {
                                throw new Error("sender doesn't have enough funds to send tx. The max cost is: " + cost_1 + " and the sender's account only has: " + balance);
                            }
                        }
                    }
                ...
                case 17:
                    ...
                    cumulativeGasUsed = ((_a = opts.blockGasUsed) !== null && _a !== void 0 ? _a : block.header.gasUsed).add(results.gasUsed);
                    _b = results;
